...
connection.execute('CREATE TABLE "Students" ( "id" INTEGER NOT NULL UNIQUE, "first_name" TEXT NOT NULL, "last_name" TEXT NOT NULL, "email" TEXT NOT NULL UNIQUE, "major" TEXT, "created_by" TEXT NOT NULL, PRIMARY KEY("id" AUTOINCREMENT) )')
